...
<div id="slide-out-widget-area-bg"
    class="<?php echo esc_attr( $ocm_class ) . ' ' . esc_attr( $side_widget_overlay_opacity ); ?>">
    <?php
...
<div id="slide-out-widget-area" class="<?php echo esc_attr( $ocm_class ); ?>"
    data-dropdown-func="<?php echo esc_attr( $dropdown_func ); ?>"
    data-back-txt="<?php echo esc_attr__( 'Back', 'salient' ); ?>">
    ...
    <div class="inner" data-prepend-menu-mobile="<?php echo esc_attr( $prepend_mobile_menu ); ?>">
        ...
        <a class="slide_out_area_close" href="#"><span
                class="screen-reader-text"><?php echo esc_html__('Close Menu','salient'); ?></span>
            <?php
					if ( $theme_skin !== 'material' ) {
            ...
            <ul class="menu">
                <?php
							...
							if( has_nav_menu( 'top_nav' ) ) {
                                ...
                                if( get_current_page_menu() == "Intern" ){
                                    $mobile_menu = "Intern Mobile";
                                }else{
                                    $mobile_menu = get_current_page_menu();
                                }
